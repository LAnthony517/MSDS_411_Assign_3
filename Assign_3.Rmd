...
model <- glm(credit.class ~ PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + PC11 + PC12 + PC13 + PC14 + PC15 + PC16 + PC17, 
...
for (ifold in seq(nfolds)) {
    ...
    model <- glm(credit.class ~ PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + PC11 + PC12 + PC13 + PC14 + PC15 + PC16 + PC17,  family = binomial, data=pcr_train)
     # evaluate on fold ifold    
